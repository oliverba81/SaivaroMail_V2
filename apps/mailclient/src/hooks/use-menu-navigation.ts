...
/** Minimal editor-like type for keyboard navigation (e.g. rich text editor with view.dom). */
...
interface MenuNavigationOptions<T> {
  /**
   * Editor instance with view.dom for attaching keyboard listener (optional).
   */
